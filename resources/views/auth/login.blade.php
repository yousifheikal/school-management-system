...
<head>
    ...
    <title>برنام ادارة المدارس</title>

    <!-- Favicon -->
    <link rel="shortcut icon" href="{{asset('assets/images/3135715.png')}}" />
...
login-->
    ...
    <section class="height-100vh d-flex align-items-center page-section-ptb login"
             style="background-color: #808080c2;">
        <div class="container">
                        ...
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <div class="section-field mb-20">
                                ...
                                <input id="email" type="email"
                                       ...
                                       value="yousifhakel50@gmail.com" required autocomplete="email" autofocus>
                                @error('email')
