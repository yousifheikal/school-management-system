                ...
                <div style="display: none" class="row setup-content" id="step-3">
                    ...
                    <div class="col-xs-12">
                        <div class="col-md-12"><br>
                            ...
                            <input type="hidden" wire:model="National_ID_Father">

                            <button class="btn btn-danger btn-sm nextBtn btn-lg pull-right" type="button"
                                    wire:click="back(2)">{{ trans('Parent_trans.Back') }}</button>

                            @if($updateMode)
                                <button class="btn btn-info btn-sm nextBtn btn-lg pull-right" wire:click="submitForm_edit"
                                        type="button">{{trans('Parent_trans.update')}}
                                </button>
                            @else
