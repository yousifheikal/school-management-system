                    ...
                    <div class="card-body">
                        <div class="accordion gray plus-icon round">
                            ...
                            @foreach ($Grades as $Grade)
                                ...
                                <div class="acd-group">
                                    <a href="#" class="acd-heading">{{ $Grade->Level_Name }}</a>
                                    <div class="acd-des">
                                                            ...
                                                            <table class="table center-aligned-table mb-0">
                                                                ...
                                                                @foreach ($Grade->Sections as $list_Sections)
                                                                    <tr>
                                                                        ...
                                                                        <td>{{$list_Sections->classroms->classroom}}</td>
                                                                        <td>
                                                                        ...
                                                                        <div class="modal-dialog" role="document">
                                                                            <div class="modal-content">
                                                                                    ...
                                                                                    <form
                                                                                        ...
                                                                                        <div class="col">
                                                                                            ...
                                                                                            <select name="Class_id"
                                                                                                    class="custom-select">
                                                                                                <option
                                                                                                    value="{{$list_Sections->classroms->classroom}}">
                                                                                ...
                                                                                <div class="modal-footer">
                                                                                    ...
                                                                                    <button type="submit"
                                                                                            class="btn btn-danger">{{ trans('Sections_trans.update') }}</button>
                                                                                </div>
                                                                                </form>
                                                                            </div>
                                                                        </div>
                                    ...
                                    <form action="{{ route('Sections.store') }}" method="POST">
                                        ...
                                        <div class="col">
                                            ...
                                            <select name="Grade_id" class="custom-select"
                                                ...
                                                @foreach ($List_Grades as $list_Grade)
                                                    <option value="{{ $list_Grade->id }}"> {{ $list_Grade->Level_Name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        </div>
