                                            ...
                                            <tr style='text-align:center;vertical-align:middle'>
                                                ...
                                                <td colspan="2">
                                                    ...
                                                    <button type="button" class="btn btn-outline-danger btn-sm"
                                                            ...
                                                            title="{{ trans('levels.Delete') }}">{{trans('Students_trans.delete')}}
                                                    </button>

                                                    <a href="{{url('open_attachment')}}/{{ $attachment->imageable->name }}/{{$attachment->filename}}" target="_blank" class="btn btn-warning btn-sm" role="button" aria-pressed="true"><i class="far fa-eye"></i></a
                                                </td>
                                            </tr>
