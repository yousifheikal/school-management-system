                        ...
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="custom-select mr-sm-2" name="blood_id">
                                        ...
                                        @foreach($bloods as $blood)
                                            <option value="{{ $blood->id }}">{{ $blood->type_blood }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text"  id="datepicker-action" name="Date_Birth" value="{{old('Date_Birth')}}" data-date-format="yyyy-mm-dd">
                                </div>
                            </div>
