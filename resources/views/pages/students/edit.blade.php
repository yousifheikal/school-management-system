                                ...
                                <div class="form-group">
                                    ...
                                    <select class="custom-select mr-sm-2" name="nationalitie_id">
                                        ...
                                        @foreach($nationals as $nal)
                                            <option value="{{ $nal->id }}" {{$nal->id == $students->nationalitie_id ? 'selected' : ""}}>{{ $nal->nationality }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="custom-select mr-sm-2" name="blood_id">
                                        ...
                                        @foreach($bloods as $bg)
                                            <option value="{{ $bg->id }}" {{$bg->id == $students->blood_id ? 'selected' : ""}}>{{ $bg->type_blood }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="custom-select mr-sm-2" name="Grade_id">
                                        ...
                                        @foreach($Grades as $Grade)
                                            <option value="{{ $Grade->id }}" {{$Grade->id == $students->Grade_id ? 'selected' : ""}}>{{ $Grade->Level_Name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <select class="custom-select mr-sm-2" name="Classroom_id">
                                        <option value="{{$students->Classroom_id}}">{{$students->classroom->classroom}}</option>
                                    </select>
                                </div>
                            </div>
